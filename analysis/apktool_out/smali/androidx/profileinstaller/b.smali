...
.field public j:[Landroidx/appcompat/view/menu/rl;
...
# virtual methods
.method public final b([Landroidx/appcompat/view/menu/rl;[B)Landroidx/profileinstaller/b;
    .locals 3
    ...
    :try_start_1
    sget-object v2, Landroidx/appcompat/view/menu/jk0;->b:[B

    invoke-static {v1, v2}, Landroidx/appcompat/view/menu/jk0;->o(Ljava/io/InputStream;[B)[B

    move-result-object v2

    invoke-static {v1, v2, p2, p1}, Landroidx/appcompat/view/menu/jk0;->q(Ljava/io/InputStream;[B[B[Landroidx/appcompat/view/menu/rl;)[Landroidx/appcompat/view/menu/rl;

    move-result-object p1

    iput-object p1, p0, Landroidx/profileinstaller/b;->j:[Landroidx/appcompat/view/menu/rl;
    :try_end_1
    ...
    :goto_1
    iput-object v0, p0, Landroidx/profileinstaller/b;->j:[Landroidx/appcompat/view/menu/rl;
...
.method public i()Landroidx/profileinstaller/b;
    ...
    invoke-virtual {p0, v0}, Landroidx/profileinstaller/b;->j(Ljava/io/InputStream;)[Landroidx/appcompat/view/menu/rl;
    ...
    :cond_1
    iget-object v0, p0, Landroidx/profileinstaller/b;->j:[Landroidx/appcompat/view/menu/rl;
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/profileinstaller/b;->b([Landroidx/appcompat/view/menu/rl;[B)Landroidx/profileinstaller/b;
...
.method public final j(Ljava/io/InputStream;)[Landroidx/appcompat/view/menu/rl;
    .locals 4

    const/4 v0, 0x7

    :try_start_0
    sget-object v1, Landroidx/appcompat/view/menu/jk0;->a:[B

    invoke-static {p1, v1}, Landroidx/appcompat/view/menu/jk0;->o(Ljava/io/InputStream;[B)[B

    move-result-object v1

    iget-object v2, p0, Landroidx/profileinstaller/b;->f:Ljava/lang/String;

    invoke-static {p1, v1, v2}, Landroidx/appcompat/view/menu/jk0;->w(Ljava/io/InputStream;[BLjava/lang/String;)[Landroidx/appcompat/view/menu/rl;
...
.method public final l(ILjava/lang/Object;)V
    ...
    new-instance v1, Landroidx/appcompat/view/menu/pl;

    invoke-direct {v1, p0, p1, p2}, Landroidx/appcompat/view/menu/pl;-><init>(Landroidx/profileinstaller/b;ILjava/lang/Object;)V
...
.method public m()Landroidx/profileinstaller/b;
    ...
    :try_start_1
    invoke-static {v3, v1}, Landroidx/appcompat/view/menu/jk0;->E(Ljava/io/OutputStream;[B)V

    invoke-static {v3, v1, v0}, Landroidx/appcompat/view/menu/jk0;->B(Ljava/io/OutputStream;[B[Landroidx/appcompat/view/menu/rl;)Z
    ...
    iput-object v2, p0, Landroidx/profileinstaller/b;->j:[Landroidx/appcompat/view/menu/rl;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public n()Z
    ...
    :try_start_2
    invoke-static {v3, v0}, Landroidx/appcompat/view/menu/lo;->l(Ljava/io/InputStream;Ljava/io/OutputStream;)V
