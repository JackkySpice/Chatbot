...
.field public c:Landroidx/appcompat/view/menu/br;
...
.field public final j:Landroidx/appcompat/view/menu/he0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroidx/lifecycle/i$a;-><init>(Landroidx/appcompat/view/menu/kj;)V
...
.method public constructor <init>(Landroidx/appcompat/view/menu/x80;)V
    .locals 1
    ...
    .line 7
    invoke-direct {p0, p1, v0}, Landroidx/lifecycle/i;-><init>(Landroidx/appcompat/view/menu/x80;Z)V

    return-void
.end method

.method public constructor <init>(Landroidx/appcompat/view/menu/x80;Z)V
    .locals 1
    ...
    .line 2
    new-instance p2, Landroidx/appcompat/view/menu/br;

    invoke-direct {p2}, Landroidx/appcompat/view/menu/br;-><init>()V

    iput-object p2, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;
    ...
    .line 6
    invoke-static {p2}, Landroidx/appcompat/view/menu/sw0;->a(Ljava/lang/Object;)Landroidx/appcompat/view/menu/he0;

    move-result-object p1

    iput-object p1, p0, Landroidx/lifecycle/i;->j:Landroidx/appcompat/view/menu/he0;
...
# virtual methods
.method public a(Landroidx/appcompat/view/menu/w80;)V
    .locals 6
    ...
    invoke-direct {v0, p1, v1}, Landroidx/lifecycle/i$b;-><init>(Landroidx/appcompat/view/menu/w80;Landroidx/lifecycle/f$b;)V

    iget-object v1, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;

    invoke-virtual {v1, p1, v0}, Landroidx/appcompat/view/menu/br;->k(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v1, Landroidx/appcompat/view/menu/x80;
    ...
    :goto_2
    invoke-virtual {p0, p1}, Landroidx/lifecycle/i;->e(Landroidx/appcompat/view/menu/w80;)Landroidx/lifecycle/f$b;
    ...
    iget-object v3, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;

    invoke-virtual {v3, p1}, Landroidx/appcompat/view/menu/br;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v1, v3}, Landroidx/lifecycle/i$b;->a(Landroidx/appcompat/view/menu/x80;Landroidx/lifecycle/f$a;)V
...
.method public c(Landroidx/appcompat/view/menu/w80;)V
    .locals 1
    ...
    iget-object v0, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;

    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/br;->n(Ljava/lang/Object;)Ljava/lang/Object;

    return-void
.end method

.method public final d(Landroidx/appcompat/view/menu/x80;)V
    .locals 5

    iget-object v0, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/cr0;->descendingIterator()Ljava/util/Iterator;
    ...
    check-cast v2, Landroidx/appcompat/view/menu/w80;
    ...
    invoke-virtual {v3, v2}, Landroidx/appcompat/view/menu/br;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, p1, v3}, Landroidx/lifecycle/i$b;->a(Landroidx/appcompat/view/menu/x80;Landroidx/lifecycle/f$a;)V
...
.method public final e(Landroidx/appcompat/view/menu/w80;)Landroidx/lifecycle/f$b;
    .locals 3

    iget-object v0, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;

    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/br;->p(Ljava/lang/Object;)Ljava/util/Map$Entry;
...
.method public final g(Landroidx/appcompat/view/menu/x80;)V
    .locals 5
...
.method public final i()Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/cr0;->size()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/cr0;->d()Ljava/util/Map$Entry;
    ...
    iget-object v2, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;

    invoke-virtual {v2}, Landroidx/appcompat/view/menu/cr0;->h()Ljava/util/Map$Entry;
...
.method public final j(Landroidx/lifecycle/f$b;)V
    ...
    new-instance p1, Landroidx/appcompat/view/menu/br;

    invoke-direct {p1}, Landroidx/appcompat/view/menu/br;-><init>()V

    iput-object p1, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;
...
.method public final m()V
    ...
    check-cast v0, Landroidx/appcompat/view/menu/x80;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/cr0;->d()Ljava/util/Map$Entry;
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/i;->d(Landroidx/appcompat/view/menu/x80;)V

    :cond_1
    iget-object v1, p0, Landroidx/lifecycle/i;->c:Landroidx/appcompat/view/menu/br;

    invoke-virtual {v1}, Landroidx/appcompat/view/menu/cr0;->h()Ljava/util/Map$Entry;
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/i;->g(Landroidx/appcompat/view/menu/x80;)V
    ...
    iget-object v0, p0, Landroidx/lifecycle/i;->j:Landroidx/appcompat/view/menu/he0;

    invoke-virtual {p0}, Landroidx/lifecycle/i;->b()Landroidx/lifecycle/f$b;

    move-result-object v1

    invoke-interface {v0, v1}, Landroidx/appcompat/view/menu/he0;->setValue(Ljava/lang/Object;)V
