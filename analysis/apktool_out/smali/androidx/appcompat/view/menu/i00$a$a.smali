...
.method public C(Ljava/lang/String;I)Landroidx/appcompat/view/menu/wp0;
    ...
    :try_start_0
    sget-object v2, Landroidx/appcompat/view/menu/i00;->b:Ljava/lang/String;
    ...
    sget-object p1, Landroidx/appcompat/view/menu/wp0;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    check-cast p1, Landroidx/appcompat/view/menu/wp0;
    :try_end_0
...
.method public N0(Ljava/lang/String;Ljava/lang/String;I)Landroidx/appcompat/view/menu/o3;
    ...
    sget-object p1, Landroidx/appcompat/view/menu/o3;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v1, p1}, Landroidx/appcompat/view/menu/i00$b;->a(Landroid/os/Parcel;Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroidx/appcompat/view/menu/o3;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public S0(Ljava/lang/String;I)Landroidx/appcompat/view/menu/xp0;
    ...
    sget-object p1, Landroidx/appcompat/view/menu/xp0;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v1, p1}, Landroidx/appcompat/view/menu/i00$b;->a(Landroid/os/Parcel;Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroidx/appcompat/view/menu/xp0;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public Z0(ILandroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/os/Bundle;)I
    ...
    invoke-static {v0, p2, p1}, Landroidx/appcompat/view/menu/i00$b;->b(Landroid/os/Parcel;Landroid/os/Parcelable;I)V
    ...
    invoke-static {v0, p8, p1}, Landroidx/appcompat/view/menu/i00$b;->b(Landroid/os/Parcel;Landroid/os/Parcelable;I)V

    iget-object p2, p0, Landroidx/appcompat/view/menu/i00$a$a;->l:Landroid/os/IBinder;
...
.method public v1(I[Landroid/content/Intent;[Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;)I
    ...
    invoke-static {v0, p5, p1}, Landroidx/appcompat/view/menu/i00$b;->b(Landroid/os/Parcel;Landroid/os/Parcelable;I)V
...
.method public x1(Landroid/content/Intent;Landroidx/appcompat/view/menu/sh0;I)V
    ...
    invoke-static {v0, p2, v2}, Landroidx/appcompat/view/menu/i00$b;->b(Landroid/os/Parcel;Landroid/os/Parcelable;I)V
...
.method public y(Landroid/content/Intent;I)Landroidx/appcompat/view/menu/e31;
    ...
    sget-object p1, Landroidx/appcompat/view/menu/e31;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v1, p1}, Landroidx/appcompat/view/menu/i00$b;->a(Landroid/os/Parcel;Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroidx/appcompat/view/menu/e31;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
