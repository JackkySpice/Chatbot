.class public final Landroidx/appcompat/view/menu/hf2;
.super Landroidx/appcompat/view/menu/cg1;
.source "SourceFile"


# instance fields
.field public o:Landroidx/appcompat/view/menu/qe1;


# direct methods
.method public constructor <init>(Landroidx/appcompat/view/menu/qe1;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/hf2;->o:Landroidx/appcompat/view/menu/qe1;
...
.method public final a(Landroidx/appcompat/view/menu/lw1;Ljava/util/List;)Landroidx/appcompat/view/menu/mg1;
    ...
    instance-of v2, v1, Landroidx/appcompat/view/menu/og1;
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/view/menu/kg1;->k(Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {p1, p2}, Landroidx/appcompat/view/menu/kg1;->h(Ljava/lang/String;)Landroidx/appcompat/view/menu/mg1;
    ...
    invoke-virtual {p1, v2}, Landroidx/appcompat/view/menu/kg1;->k(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {p1, v2}, Landroidx/appcompat/view/menu/kg1;->h(Ljava/lang/String;)Landroidx/appcompat/view/menu/mg1;
    ...
    :goto_0
    iget-object v2, p0, Landroidx/appcompat/view/menu/hf2;->o:Landroidx/appcompat/view/menu/qe1;

    check-cast v1, Landroidx/appcompat/view/menu/og1;

    invoke-virtual {v2, v0, p1, v1, p2}, Landroidx/appcompat/view/menu/qe1;->c(Ljava/lang/String;ILandroidx/appcompat/view/menu/og1;Ljava/lang/String;)V
