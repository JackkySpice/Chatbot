.class public final Landroidx/appcompat/view/menu/je$c;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/je$c;->g:Landroid/util/ArrayMap;
...
.method public synthetic constructor <init>(Landroidx/appcompat/view/menu/le;)V
    ...
    .line 1
    invoke-direct {p0}, Landroidx/appcompat/view/menu/je$c;-><init>()V

    return-void
.end method

.method public static bridge synthetic r(Landroidx/appcompat/view/menu/je$c;)Landroid/util/ArrayMap;
    .locals 0

    iget-object p0, p0, Landroidx/appcompat/view/menu/je$c;->g:Landroid/util/ArrayMap;
...
.method public bridge synthetic f(Ljava/lang/String;Landroidx/appcompat/view/menu/t6$f;)Z
    ...
    check-cast p2, Landroidx/appcompat/view/menu/t6$l;

    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/view/menu/je$c;->t(Ljava/lang/String;Landroidx/appcompat/view/menu/t6$l;)Z
...
.method public bridge synthetic g(I)[Landroidx/appcompat/view/menu/t6$f;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/je$c;->u(I)[Landroidx/appcompat/view/menu/t6$l;
...
.method public bridge synthetic h(Landroidx/appcompat/view/menu/t6$f;II)Ljava/lang/Object;
    ...
    check-cast p1, Landroidx/appcompat/view/menu/t6$l;

    invoke-virtual {p0, p1, p2, p3}, Landroidx/appcompat/view/menu/je$c;->v(Landroidx/appcompat/view/menu/t6$l;II)Landroid/content/pm/ResolveInfo;
...
.method public s(Landroidx/appcompat/view/menu/t6$k;)V
    .locals 3

    iget-object v0, p0, Landroidx/appcompat/view/menu/je$c;->g:Landroid/util/ArrayMap;
    ...
    check-cast v2, Landroidx/appcompat/view/menu/t6$l;
...
.method public t(Ljava/lang/String;Landroidx/appcompat/view/menu/t6$l;)Z
    .locals 0

    iget-object p2, p2, Landroidx/appcompat/view/menu/t6$l;->t:Landroidx/appcompat/view/menu/t6$k;
...
.method public u(I)[Landroidx/appcompat/view/menu/t6$l;
    .locals 0

    new-array p1, p1, [Landroidx/appcompat/view/menu/t6$l;

    return-object p1
.end method

.method public v(Landroidx/appcompat/view/menu/t6$l;II)Landroid/content/pm/ResolveInfo;
    .locals 3

    iget-object v0, p1, Landroidx/appcompat/view/menu/t6$l;->t:Landroidx/appcompat/view/menu/t6$k;
    ...
    :cond_0
    iget v2, p0, Landroidx/appcompat/view/menu/je$c;->h:I

    invoke-virtual {v1, p3}, Landroidx/appcompat/view/menu/x6;->e(I)Landroidx/appcompat/view/menu/y6;

    move-result-object v1

    invoke-static {v0, v2, v1, p3}, Landroidx/appcompat/view/menu/vg0;->j(Landroidx/appcompat/view/menu/t6$k;ILandroidx/appcompat/view/menu/y6;I)Landroid/content/pm/ServiceInfo;
    ...
    iget p3, p0, Landroidx/appcompat/view/menu/je$c;->h:I
...
.method public w(Landroid/content/Intent;Ljava/lang/String;II)Ljava/util/List;
    ...
    iput p3, p0, Landroidx/appcompat/view/menu/je$c;->h:I
...
.method public x(Landroid/content/Intent;Ljava/lang/String;ILjava/util/List;I)Ljava/util/List;
    ...
    new-array v2, v2, [Landroidx/appcompat/view/menu/t6$l;
...
.method public y(Landroidx/appcompat/view/menu/t6$k;)V
    .locals 3
