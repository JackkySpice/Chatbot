.class public abstract Landroidx/appcompat/view/menu/ew;
...
.method public static f(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/appcompat/view/menu/ew;->i(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroidx/appcompat/view/menu/ew;->i(Ljava/util/List;Landroid/view/View;I)Z

    move-result v5

    if-nez v5, :cond_2

    invoke-static {v4}, Landroidx/appcompat/view/menu/i51;->F(Landroid/view/View;)Ljava/lang/String;
...
.method public q(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroidx/appcompat/view/menu/i51;->F(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Landroidx/appcompat/view/menu/i51;->A0(Landroid/view/View;Ljava/lang/String;)V
...
.method public w(Landroidx/appcompat/view/menu/ev;Ljava/lang/Object;Landroidx/appcompat/view/menu/ba;Ljava/lang/Runnable;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/appcompat/view/menu/ew;->x(Landroidx/appcompat/view/menu/ev;Ljava/lang/Object;Landroidx/appcompat/view/menu/ba;Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    return-void
.end method

.method public x(Landroidx/appcompat/view/menu/ev;Ljava/lang/Object;Landroidx/appcompat/view/menu/ba;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    .locals 0
...
.method public y(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v5}, Landroidx/appcompat/view/menu/i51;->A0(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_3
    new-instance p5, Landroidx/appcompat/view/menu/ew$a;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/appcompat/view/menu/ew$a;-><init>(Landroidx/appcompat/view/menu/ew;ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Landroidx/appcompat/view/menu/kg0;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/appcompat/view/menu/kg0;
