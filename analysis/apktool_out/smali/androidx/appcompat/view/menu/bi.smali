...
.method public a(Landroidx/appcompat/view/menu/x6;Landroidx/appcompat/view/menu/l50;I)I
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/view/menu/hv0;->k(Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/view/menu/hv0;->g(Ljava/lang/String;I)Ljava/io/File;

    move-result-object p2

    invoke-static {p2}, Landroidx/appcompat/view/menu/pr;->g(Ljava/io/File;)V

    invoke-static {p1, p3}, Landroidx/appcompat/view/menu/hv0;->j(Ljava/lang/String;I)Ljava/io/File;

    move-result-object p2

    invoke-static {p2}, Landroidx/appcompat/view/menu/pr;->g(Ljava/io/File;)V

    invoke-static {p1, p3}, Landroidx/appcompat/view/menu/hv0;->h(Ljava/lang/String;I)Ljava/io/File;

    move-result-object p2

    invoke-static {p2}, Landroidx/appcompat/view/menu/pr;->g(Ljava/io/File;)V

    invoke-static {p1, p3}, Landroidx/appcompat/view/menu/hv0;->l(Ljava/lang/String;I)Ljava/io/File;
