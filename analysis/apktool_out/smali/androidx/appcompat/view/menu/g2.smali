.class public Landroidx/appcompat/view/menu/g2;
...
.field public final b:Landroidx/appcompat/view/menu/td0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/view/menu/g2;->e:Landroid/graphics/Matrix;
...
.method public constructor <init>(Lio/flutter/embedding/engine/renderer/FlutterRenderer;Z)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/g2;->d:Ljava/util/Map;

    iput-object p1, p0, Landroidx/appcompat/view/menu/g2;->a:Lio/flutter/embedding/engine/renderer/FlutterRenderer;

    invoke-static {}, Landroidx/appcompat/view/menu/td0;->a()Landroidx/appcompat/view/menu/td0;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/view/menu/g2;->b:Landroidx/appcompat/view/menu/td0;

    iput-boolean p2, p0, Landroidx/appcompat/view/menu/g2;->c:Z
...
.method public final a(Landroid/view/MotionEvent;IIILandroid/graphics/Matrix;Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/appcompat/view/menu/g2;->b(Landroid/view/MotionEvent;IIILandroid/graphics/Matrix;Ljava/nio/ByteBuffer;Landroid/content/Context;)V
...
.method public final b(Landroid/view/MotionEvent;IIILandroid/graphics/Matrix;Ljava/nio/ByteBuffer;Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v8}, Landroidx/appcompat/view/menu/g2;->f(I)I
    ...
    iget-object v11, v0, Landroidx/appcompat/view/menu/g2;->d:Ljava/util/Map;
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/view/menu/g2;->e(I)I
    ...
    :cond_5
    iget-boolean v14, v0, Landroidx/appcompat/view/menu/g2;->c:Z

    if-eqz v14, :cond_6

    iget-object v14, v0, Landroidx/appcompat/view/menu/g2;->b:Landroidx/appcompat/view/menu/td0;

    invoke-virtual {v14, v1}, Landroidx/appcompat/view/menu/td0;->c(Landroid/view/MotionEvent;)Landroidx/appcompat/view/menu/td0$a;

    move-result-object v14

    invoke-virtual {v14}, Landroidx/appcompat/view/menu/td0$a;->d()J
    ...
    iget-object v3, v0, Landroidx/appcompat/view/menu/g2;->d:Ljava/util/Map;
    ...
    invoke-virtual {v0, v5}, Landroidx/appcompat/view/menu/g2;->c(Landroid/content/Context;)F

    move-result v6

    float-to-double v8, v6

    invoke-virtual {v0, v5}, Landroidx/appcompat/view/menu/g2;->g(Landroid/content/Context;)F
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/g2;->d:Ljava/util/Map;
...
.method public final g(Landroid/content/Context;)F
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/g2;->h(Landroid/content/Context;)F
...
.method public i(Landroid/view/MotionEvent;Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/g2;->d(I)I
    ...
    sget-object v9, Landroidx/appcompat/view/menu/g2;->e:Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v4 .. v11}, Landroidx/appcompat/view/menu/g2;->b(Landroid/view/MotionEvent;IIILandroid/graphics/Matrix;Ljava/nio/ByteBuffer;Landroid/content/Context;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/g2;->a:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
...
.method public j(Landroid/view/MotionEvent;)Z
    ...
    sget-object v0, Landroidx/appcompat/view/menu/g2;->e:Landroid/graphics/Matrix;

    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/view/menu/g2;->k(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Z
...
.method public k(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Z
    ...
    invoke-virtual {p0, v3}, Landroidx/appcompat/view/menu/g2;->d(I)I
    ...
    invoke-virtual/range {v2 .. v8}, Landroidx/appcompat/view/menu/g2;->a(Landroid/view/MotionEvent;IIILandroid/graphics/Matrix;Ljava/nio/ByteBuffer;)V
