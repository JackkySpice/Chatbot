...
.field public final b:Landroidx/appcompat/view/menu/wu;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/wu;Landroidx/emoji2/text/e$a;)V
    .locals 1
    ...
    invoke-static {p2, v0}, Landroidx/appcompat/view/menu/mj0;->h(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, p0, Landroidx/emoji2/text/e$b;->b:Landroidx/appcompat/view/menu/wu;
...
.method public c()V
    ...
    :try_start_1
    invoke-virtual {p0}, Landroidx/emoji2/text/e$b;->e()Landroidx/appcompat/view/menu/av$b;

    move-result-object v0

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/av$b;->b()I
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/e$a;->a(Landroid/content/Context;Landroidx/appcompat/view/menu/av$b;)Landroid/graphics/Typeface;

    move-result-object v1

    iget-object v2, p0, Landroidx/emoji2/text/e$b;->a:Landroid/content/Context;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/av$b;->d()Landroid/net/Uri;

    move-result-object v0

    const/4 v3, 0x0

    invoke-static {v2, v3, v0}, Landroidx/appcompat/view/menu/u21;->e(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
...
.method public d()V
    ...
    invoke-static {v1}, Landroidx/appcompat/view/menu/ve;->b(Ljava/lang/String;)Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    new-instance v2, Landroidx/appcompat/view/menu/xu;

    invoke-direct {v2, p0}, Landroidx/appcompat/view/menu/xu;-><init>(Landroidx/emoji2/text/e$b;)V
...
.method public final e()Landroidx/appcompat/view/menu/av$b;
    .locals 4
    ...
    iget-object v2, p0, Landroidx/emoji2/text/e$b;->b:Landroidx/appcompat/view/menu/wu;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/e$a;->b(Landroid/content/Context;Landroidx/appcompat/view/menu/wu;)Landroidx/appcompat/view/menu/av$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/av$a;->c()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/av$a;->b()[Landroidx/appcompat/view/menu/av$b;
