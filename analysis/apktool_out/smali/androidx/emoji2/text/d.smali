...
.method public static a(Landroid/text/Editable;Landroid/view/KeyEvent;Z)Z
    ...
    :cond_1
    const-class v2, Landroidx/appcompat/view/menu/un;

    invoke-interface {p0, p1, v1, v2}, Landroid/text/Spanned;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object v1

    check-cast v1, [Landroidx/appcompat/view/menu/un;
...
.method public static b(Landroid/view/inputmethod/InputConnection;Landroid/text/Editable;IIZ)Z
    ...
    :cond_5
    const-class p4, Landroidx/appcompat/view/menu/un;

    invoke-interface {p1, p2, p3, p4}, Landroid/text/Spanned;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object p4

    check-cast p4, [Landroidx/appcompat/view/menu/un;
...
# virtual methods
.method public final d(Ljava/lang/CharSequence;IILandroidx/appcompat/view/menu/v21;)Z
    .locals 2

    invoke-virtual {p4}, Landroidx/appcompat/view/menu/v21;->d()I
    ...
    invoke-virtual {p4}, Landroidx/appcompat/view/menu/v21;->h()S
    ...
    invoke-virtual {p4, p1}, Landroidx/appcompat/view/menu/v21;->m(Z)V
...
.method public h(Ljava/lang/CharSequence;IIIZ)Ljava/lang/CharSequence;
    ...
    instance-of v0, p1, Landroidx/appcompat/view/menu/yv0;
    ...
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/yv0;->a()V

    :cond_0
    const-class v1, Landroidx/appcompat/view/menu/un;
    ...
    new-instance v2, Landroidx/appcompat/view/menu/r31;

    invoke-direct {v2, p1}, Landroidx/appcompat/view/menu/r31;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v2, v3}, Landroidx/appcompat/view/menu/r31;-><init>(Landroid/text/Spannable;)V
    ...
    invoke-virtual {v2, p2, p3, v1}, Landroidx/appcompat/view/menu/r31;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object v4

    check-cast v4, [Landroidx/appcompat/view/menu/un;
    ...
    invoke-virtual {v2, v7}, Landroidx/appcompat/view/menu/r31;->getSpanStart(Ljava/lang/Object;)I

    move-result v8

    invoke-virtual {v2, v7}, Landroidx/appcompat/view/menu/r31;->getSpanEnd(Ljava/lang/Object;)I

    move-result v9

    if-eq v8, p3, :cond_4

    invoke-virtual {v2, v7}, Landroidx/appcompat/view/menu/r31;->removeSpan(Ljava/lang/Object;)V
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/r31;->length()I

    move-result p3

    invoke-virtual {v2, v3, p3, v1}, Landroidx/appcompat/view/menu/r31;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object p3

    check-cast p3, [Landroidx/appcompat/view/menu/un;
    ...
    invoke-direct {v7, v2, p3}, Landroidx/emoji2/text/d$b;-><init>(Landroidx/appcompat/view/menu/r31;Landroidx/emoji2/text/c$j;)V
    ...
    check-cast p2, Landroidx/appcompat/view/menu/r31;

    if-eqz p2, :cond_9

    invoke-virtual {p2}, Landroidx/appcompat/view/menu/r31;->b()Landroid/text/Spannable;
    ...
    invoke-virtual {p2}, Landroidx/appcompat/view/menu/yv0;->d()V
...
.method public final i(Ljava/lang/CharSequence;IIIZLandroidx/emoji2/text/d$c;)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroidx/emoji2/text/d$e;->c()Landroidx/appcompat/view/menu/v21;

    move-result-object v6

    invoke-virtual {p0, p1, v1, p2, v6}, Landroidx/emoji2/text/d;->d(Ljava/lang/CharSequence;IILandroidx/appcompat/view/menu/v21;)Z
    ...
    invoke-interface {p6, p1, v1, p2, v5}, Landroidx/emoji2/text/d$c;->b(Ljava/lang/CharSequence;IILandroidx/appcompat/view/menu/v21;)Z
    ...
    invoke-virtual {v0}, Landroidx/emoji2/text/d$e;->b()Landroidx/appcompat/view/menu/v21;

    move-result-object p3

    invoke-virtual {p0, p1, v1, p2, p3}, Landroidx/emoji2/text/d;->d(Ljava/lang/CharSequence;IILandroidx/appcompat/view/menu/v21;)Z
    ...
    invoke-interface {p6, p1, v1, p2, p3}, Landroidx/emoji2/text/d$c;->b(Ljava/lang/CharSequence;IILandroidx/appcompat/view/menu/v21;)Z
