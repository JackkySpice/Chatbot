...
# virtual methods
.method public final a(Landroid/content/Context;Landroidx/appcompat/view/menu/wu;)Landroidx/emoji2/text/c$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/e;-><init>(Landroid/content/Context;Landroidx/appcompat/view/menu/wu;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/c$c;
    ...
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/a$a;->h(Landroid/content/Context;)Landroidx/appcompat/view/menu/wu;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Landroidx/emoji2/text/a$a;->a(Landroid/content/Context;Landroidx/appcompat/view/menu/wu;)Landroidx/emoji2/text/c$c;
...
.method public final d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Landroidx/appcompat/view/menu/wu;
    .locals 3
    ...
    new-instance v1, Landroidx/appcompat/view/menu/wu;

    const-string v2, "emojicompat-emoji-font"

    invoke-direct {v1, v0, p1, v2, p2}, Landroidx/appcompat/view/menu/wu;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public h(Landroid/content/Context;)Landroidx/appcompat/view/menu/wu;
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, v0, p1}, Landroidx/emoji2/text/a$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Landroidx/appcompat/view/menu/wu;
