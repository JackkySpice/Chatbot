...
.field public k:Landroidx/appcompat/view/menu/kf;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;
    ...
    iput-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->k:Landroidx/appcompat/view/menu/kf;
...
.method public c(ZLandroid/view/View;Landroidx/appcompat/view/menu/lf;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;)V
    .locals 18
    ...
    invoke-virtual {v7, v2}, Landroidx/appcompat/view/menu/lf;->D0(I)V
    ...
    invoke-virtual {v7, v11}, Landroidx/appcompat/view/menu/lf;->p0(Z)V
    ...
    :cond_0
    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->c0(Ljava/lang/Object;)V
    ...
    iget-object v2, v0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;

    invoke-virtual {v2}, Landroidx/appcompat/view/menu/mf;->a1()Z

    move-result v2

    invoke-virtual {v1, v7, v2}, Landroidx/constraintlayout/widget/c;->h(Landroidx/appcompat/view/menu/lf;Z)V
    ...
    check-cast v1, Landroidx/appcompat/view/menu/ly;
    ...
    invoke-virtual {v1, v4}, Landroidx/appcompat/view/menu/ly;->Q0(F)V
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/view/menu/ly;->O0(I)V
    ...
    invoke-virtual {v1, v3}, Landroidx/appcompat/view/menu/ly;->P0(I)V
    ...
    invoke-virtual {v7, v1, v2, v3}, Landroidx/appcompat/view/menu/lf;->k(Landroidx/appcompat/view/menu/lf;FI)V
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/appcompat/view/menu/lf;->T(Landroidx/appcompat/view/menu/jf$b;Landroidx/appcompat/view/menu/lf;Landroidx/appcompat/view/menu/jf$b;II)V
    ...
    sget-object v2, Landroidx/appcompat/view/menu/jf$b;->n:Landroidx/appcompat/view/menu/jf$b;
    ...
    sget-object v2, Landroidx/appcompat/view/menu/jf$b;->o:Landroidx/appcompat/view/menu/jf$b;

    sget-object v4, Landroidx/appcompat/view/menu/jf$b;->q:Landroidx/appcompat/view/menu/jf$b;
    ...
    sget-object v3, Landroidx/appcompat/view/menu/jf$b;->r:Landroidx/appcompat/view/menu/jf$b;

    invoke-virtual {v7, v3}, Landroidx/appcompat/view/menu/lf;->m(Landroidx/appcompat/view/menu/jf$b;)Landroidx/appcompat/view/menu/jf;
    ...
    invoke-virtual {v4, v2, v10, v12, v11}, Landroidx/appcompat/view/menu/jf;->b(Landroidx/appcompat/view/menu/jf;IIZ)Z

    invoke-virtual {v7, v11}, Landroidx/appcompat/view/menu/lf;->g0(Z)V

    iget-object v1, v1, Landroidx/constraintlayout/widget/ConstraintLayout$b;->n0:Landroidx/appcompat/view/menu/lf;

    invoke-virtual {v1, v11}, Landroidx/appcompat/view/menu/lf;->g0(Z)V

    sget-object v1, Landroidx/appcompat/view/menu/jf$b;->o:Landroidx/appcompat/view/menu/jf$b;

    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->m(Landroidx/appcompat/view/menu/jf$b;)Landroidx/appcompat/view/menu/jf;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/appcompat/view/menu/jf;->l()V
    ...
    invoke-virtual {v7, v2}, Landroidx/appcompat/view/menu/lf;->i0(F)V
    ...
    invoke-virtual {v7, v2}, Landroidx/appcompat/view/menu/lf;->x0(F)V
    ...
    invoke-virtual {v7, v1, v2}, Landroidx/appcompat/view/menu/lf;->v0(II)V
    ...
    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->l0(Landroidx/appcompat/view/menu/lf$b;)V
    ...
    iput v3, v1, Landroidx/appcompat/view/menu/jf;->e:I

    sget-object v1, Landroidx/appcompat/view/menu/jf$b;->p:Landroidx/appcompat/view/menu/jf$b;
    ...
    invoke-virtual {v7, v10}, Landroidx/appcompat/view/menu/lf;->E0(I)V
    ...
    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->E0(I)V

    iget v1, v8, Landroid/view/ViewGroup$MarginLayoutParams;->width:I

    if-ne v1, v2, :cond_17

    sget-object v1, Landroidx/appcompat/view/menu/lf$b;->n:Landroidx/appcompat/view/menu/lf$b;
    ...
    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->A0(Landroidx/appcompat/view/menu/lf$b;)V
    ...
    iput v2, v1, Landroidx/appcompat/view/menu/jf;->e:I
    ...
    invoke-virtual {v7, v10}, Landroidx/appcompat/view/menu/lf;->h0(I)V
    ...
    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->h0(I)V
    ...
    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->e0(Ljava/lang/String;)V

    iget v1, v8, Landroidx/constraintlayout/widget/ConstraintLayout$b;->E:F

    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->n0(F)V

    iget v1, v8, Landroidx/constraintlayout/widget/ConstraintLayout$b;->F:F

    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->C0(F)V

    iget v1, v8, Landroidx/constraintlayout/widget/ConstraintLayout$b;->G:I

    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->j0(I)V

    iget v1, v8, Landroidx/constraintlayout/widget/ConstraintLayout$b;->H:I

    invoke-virtual {v7, v1}, Landroidx/appcompat/view/menu/lf;->y0(I)V
    ...
    invoke-virtual {v7, v1, v2, v3, v4}, Landroidx/appcompat/view/menu/lf;->m0(IIIF)V
    ...
    invoke-virtual {v7, v1, v2, v3, v4}, Landroidx/appcompat/view/menu/lf;->B0(IIIF)V
...
.method public final g(I)Landroidx/appcompat/view/menu/lf;
    .locals 1

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;
    ...
    iget-object p1, p1, Landroidx/constraintlayout/widget/ConstraintLayout$b;->n0:Landroidx/appcompat/view/menu/lf;
...
.method public getOptimizationLevel()I
    ...
    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/mf;->V0()I
...
.method public final i(Landroid/view/View;)Landroidx/appcompat/view/menu/lf;
    .locals 0
...
.method public final j(Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {v0, p0}, Landroidx/appcompat/view/menu/lf;->c0(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/mf;->f1(Landroidx/appcompat/view/menu/d8$b;)V
    ...
    sget-object v2, Landroidx/appcompat/view/menu/cn0;->a1:[I
    ...
    sget v3, Landroidx/appcompat/view/menu/cn0;->k1:I
    ...
    :cond_0
    sget v3, Landroidx/appcompat/view/menu/cn0;->l1:I
    ...
    :cond_1
    sget v3, Landroidx/appcompat/view/menu/cn0;->i1:I
    ...
    :cond_2
    sget v3, Landroidx/appcompat/view/menu/cn0;->j1:I
    ...
    :cond_3
    sget v3, Landroidx/appcompat/view/menu/cn0;->L2:I
    ...
    :cond_4
    sget v3, Landroidx/appcompat/view/menu/cn0;->M1:I
    ...
    :cond_5
    sget v3, Landroidx/appcompat/view/menu/cn0;->s1:I
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/view/menu/mf;->g1(I)V
...
.method public m(I)V
    ...
    new-instance v0, Landroidx/appcompat/view/menu/kf;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1, p0, p1}, Landroidx/appcompat/view/menu/kf;-><init>(Landroid/content/Context;Landroidx/constraintlayout/widget/ConstraintLayout;I)V
...
.method public o(Landroidx/appcompat/view/menu/mf;III)V
    .locals 20
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->r(Landroidx/appcompat/view/menu/mf;IIII)V
    ...
    invoke-virtual/range {v7 .. v16}, Landroidx/appcompat/view/menu/mf;->c1(IIIIIIIII)J
...
.method public onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->n0:Landroidx/appcompat/view/menu/lf;
    ...
    :cond_1
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/lf;->Q()I

    move-result v0

    invoke-virtual {v1}, Landroidx/appcompat/view/menu/lf;->R()I
...
.method public onMeasure(II)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/mf;->h1(Z)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/mf;->j1()V
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Landroidx/constraintlayout/widget/ConstraintLayout;->o(Landroidx/appcompat/view/menu/mf;III)V

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/lf;->P()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/mf;->b1()Z

    move-result v6

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/mf;->Z0()Z
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->i(Landroid/view/View;)Landroidx/appcompat/view/menu/lf;
    ...
    instance-of v0, v0, Landroidx/appcompat/view/menu/ly;
    ...
    new-instance v1, Landroidx/appcompat/view/menu/ly;

    invoke-direct {v1}, Landroidx/appcompat/view/menu/ly;-><init>()V

    iput-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->n0:Landroidx/appcompat/view/menu/lf;
    ...
    invoke-virtual {v1, v0}, Landroidx/appcompat/view/menu/ly;->R0(I)V
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;

    invoke-virtual {v1, v0}, Landroidx/appcompat/view/menu/t71;->L0(Landroidx/appcompat/view/menu/lf;)V
...
.method public final p()V
    ...
    invoke-virtual {p0, v2}, Landroidx/constraintlayout/widget/ConstraintLayout;->i(Landroid/view/View;)Landroidx/appcompat/view/menu/lf;
    ...
    :cond_0
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/lf;->Y()V
    ...
    invoke-virtual {p0, v3}, Landroidx/constraintlayout/widget/ConstraintLayout;->g(I)Landroidx/appcompat/view/menu/lf;

    move-result-object v3

    invoke-virtual {v3, v4}, Landroidx/appcompat/view/menu/lf;->d0(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/t71;->M0()V
    ...
    iget-object v2, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;
    ...
    iget-object v3, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Landroidx/appcompat/view/menu/mf;
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/view/menu/t71;->a(Landroidx/appcompat/view/menu/lf;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->c(ZLandroid/view/View;Landroidx/appcompat/view/menu/lf;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;)V
...
.method public r(Landroidx/appcompat/view/menu/mf;IIII)V
    .locals 7
    ...
    :cond_2
    sget-object p2, Landroidx/appcompat/view/menu/lf$b;->n:Landroidx/appcompat/view/menu/lf$b;
    ...
    :cond_a
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/mf;->Y0()V

    :cond_b
    invoke-virtual {p1, v6}, Landroidx/appcompat/view/menu/lf;->F0(I)V

    invoke-virtual {p1, v6}, Landroidx/appcompat/view/menu/lf;->G0(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->f:I

    sub-int/2addr p4, v0

    invoke-virtual {p1, p4}, Landroidx/appcompat/view/menu/lf;->s0(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->g:I

    sub-int/2addr p4, v1

    invoke-virtual {p1, p4}, Landroidx/appcompat/view/menu/lf;->r0(I)V

    invoke-virtual {p1, v6}, Landroidx/appcompat/view/menu/lf;->u0(I)V

    invoke-virtual {p1, v6}, Landroidx/appcompat/view/menu/lf;->t0(I)V

    invoke-virtual {p1, p2}, Landroidx/appcompat/view/menu/lf;->l0(Landroidx/appcompat/view/menu/lf$b;)V

    invoke-virtual {p1, p3}, Landroidx/appcompat/view/menu/lf;->E0(I)V

    invoke-virtual {p1, v2}, Landroidx/appcompat/view/menu/lf;->A0(Landroidx/appcompat/view/menu/lf$b;)V

    invoke-virtual {p1, p5}, Landroidx/appcompat/view/menu/lf;->h0(I)V
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/view/menu/lf;->t0(I)V
...
.method public setOnConstraintsChanged(Landroidx/appcompat/view/menu/nf;)V
    .locals 1

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->k:Landroidx/appcompat/view/menu/kf;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/kf;->c(Landroidx/appcompat/view/menu/nf;)V
...
.method public setOptimizationLevel(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/mf;->g1(I)V
