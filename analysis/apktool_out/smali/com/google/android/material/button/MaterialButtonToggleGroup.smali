...
.method static constructor <clinit>()V
    ...
    sget v0, Landroidx/appcompat/view/menu/an0;->i:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Landroidx/appcompat/view/menu/vl0;->o:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 9
    sget-object v2, Landroidx/appcompat/view/menu/hn0;->o2:[I
    ...
    .line 11
    sget p3, Landroidx/appcompat/view/menu/hn0;->s2:I
    ...
    .line 14
    sget p3, Landroidx/appcompat/view/menu/hn0;->q2:I
    ...
    .line 16
    sget p3, Landroidx/appcompat/view/menu/hn0;->r2:I
    ...
    .line 19
    sget p3, Landroidx/appcompat/view/menu/hn0;->p2:I
...
.method public static p(Landroidx/appcompat/view/menu/ot0$b;Lcom/google/android/material/button/MaterialButtonToggleGroup$c;)V
    .locals 1
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/ot0$b;->o(F)Landroidx/appcompat/view/menu/ot0$b;

    return-void

    :cond_0
    iget-object v0, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;->a:Landroidx/appcompat/view/menu/fh;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ot0$b;->B(Landroidx/appcompat/view/menu/fh;)Landroidx/appcompat/view/menu/ot0$b;

    move-result-object p0

    iget-object v0, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;->d:Landroidx/appcompat/view/menu/fh;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ot0$b;->t(Landroidx/appcompat/view/menu/fh;)Landroidx/appcompat/view/menu/ot0$b;

    move-result-object p0

    iget-object v0, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;->b:Landroidx/appcompat/view/menu/fh;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ot0$b;->F(Landroidx/appcompat/view/menu/fh;)Landroidx/appcompat/view/menu/ot0$b;

    move-result-object p0

    iget-object p1, p1, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;->c:Landroidx/appcompat/view/menu/fh;

    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/ot0$b;->x(Landroidx/appcompat/view/menu/fh;)Landroidx/appcompat/view/menu/ot0$b;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/material/button/MaterialButton;->getShapeAppearanceModel()Landroidx/appcompat/view/menu/ot0;
    ...
    invoke-direct {v0, v1, v2, v3, p2}, Lcom/google/android/material/button/MaterialButtonToggleGroup$c;-><init>(Landroidx/appcompat/view/menu/fh;Landroidx/appcompat/view/menu/fh;Landroidx/appcompat/view/menu/fh;Landroidx/appcompat/view/menu/fh;)V
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/view/menu/i51;->k0(Landroid/view/View;Landroidx/appcompat/view/menu/b0;)V
...
.method public final c()V
    ...
    invoke-static {v4, v6}, Landroidx/appcompat/view/menu/cb0;->c(Landroid/view/ViewGroup$MarginLayoutParams;I)V

    neg-int v3, v3

    invoke-static {v4, v3}, Landroidx/appcompat/view/menu/cb0;->d(Landroid/view/ViewGroup$MarginLayoutParams;I)V
    ...
    invoke-static {v4, v6}, Landroidx/appcompat/view/menu/cb0;->d(Landroid/view/ViewGroup$MarginLayoutParams;I)V
...
.method public final n(I)V
    ...
    :cond_1
    invoke-static {p1, v2}, Landroidx/appcompat/view/menu/cb0;->c(Landroid/view/ViewGroup$MarginLayoutParams;I)V

    invoke-static {p1, v2}, Landroidx/appcompat/view/menu/cb0;->d(Landroid/view/ViewGroup$MarginLayoutParams;I)V
...
.method public s()V
    ...
    :cond_0
    invoke-virtual {v4}, Lcom/google/android/material/button/MaterialButton;->getShapeAppearanceModel()Landroidx/appcompat/view/menu/ot0;

    move-result-object v5

    invoke-virtual {v5}, Landroidx/appcompat/view/menu/ot0;->v()Landroidx/appcompat/view/menu/ot0$b;
    ...
    invoke-static {v5, v6}, Lcom/google/android/material/button/MaterialButtonToggleGroup;->p(Landroidx/appcompat/view/menu/ot0$b;Lcom/google/android/material/button/MaterialButtonToggleGroup$c;)V

    invoke-virtual {v5}, Landroidx/appcompat/view/menu/ot0$b;->m()Landroidx/appcompat/view/menu/ot0;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/google/android/material/button/MaterialButton;->setShapeAppearanceModel(Landroidx/appcompat/view/menu/ot0;)V
