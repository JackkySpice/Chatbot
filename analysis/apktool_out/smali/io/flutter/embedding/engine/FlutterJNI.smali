...
.field private deferredComponentManager:Landroidx/appcompat/view/menu/pk;
...
.field private final flutterUiDisplayListeners:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Landroidx/appcompat/view/menu/mu;",
            ">;"
        }
    .end annotation
.end field

.field private localizationPlugin:Landroidx/appcompat/view/menu/q90;

.field private final mainLooper:Landroid/os/Looper;

.field private nativeShellHolderId:Ljava/lang/Long;

.field private platformMessageHandler:Landroidx/appcompat/view/menu/ei0;

.field private platformViewsController:Landroidx/appcompat/view/menu/xi0;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p1, p2}, Landroidx/appcompat/view/menu/ut;-><init>(J)V
    ...
    invoke-static {p1, p2, p0}, Landroidx/appcompat/view/menu/ba0;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Landroidx/appcompat/view/menu/ei0;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Landroidx/appcompat/view/menu/ei0;->c(ILjava/nio/ByteBuffer;)V
...
.method public addIsDisplayingFlutterUiListener(Landroidx/appcompat/view/menu/mu;)V
    .locals 1
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Landroidx/appcompat/view/menu/q90;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Landroidx/appcompat/view/menu/q90;

    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/q90;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Landroidx/appcompat/view/menu/xi0;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/xi0;->A()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Landroidx/appcompat/view/menu/ba0;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/a$g;Ljava/lang/Object;)V
    ...
    .line 3
    sget-object v0, Landroidx/appcompat/view/menu/lw0;->a:Landroidx/appcompat/view/menu/lw0;

    invoke-virtual {v0, p3}, Landroidx/appcompat/view/menu/lw0;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Landroidx/appcompat/view/menu/mt0;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Landroidx/appcompat/view/menu/ei0;->d(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public onBeginFrame()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/xi0;->S()V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/appcompat/view/menu/xi0;->U(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v1, v0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Landroidx/appcompat/view/menu/xi0;
    ...
    invoke-virtual/range {v1 .. v9}, Landroidx/appcompat/view/menu/xi0;->V(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public onEndFrame()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/xi0;->W()V
...
.method public removeIsDisplayingFlutterUiListener(Landroidx/appcompat/view/menu/mu;)V
    .locals 1
...
.method public setDeferredComponentManager(Landroidx/appcompat/view/menu/pk;)V
    .locals 0
    ...
    invoke-interface {p1, p0}, Landroidx/appcompat/view/menu/pk;->a(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Landroidx/appcompat/view/menu/q90;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Landroidx/appcompat/view/menu/q90;

    return-void
.end method

.method public setPlatformMessageHandler(Landroidx/appcompat/view/menu/ei0;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Landroidx/appcompat/view/menu/ei0;

    return-void
.end method

.method public setPlatformViewsController(Landroidx/appcompat/view/menu/xi0;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Landroidx/appcompat/view/menu/xi0;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Landroidx/appcompat/view/menu/lj0;->a(ZLjava/lang/Object;)V
