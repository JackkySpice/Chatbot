...
.method private createImageReader29()Landroid/media/ImageReader;
    ...
    invoke-static/range {v0 .. v5}, Landroidx/appcompat/view/menu/qt;->a(IIIIJ)Landroid/media/ImageReader;
...
.method private createImageReader33()Landroid/media/ImageReader;
    ...
    invoke-static {}, Landroidx/appcompat/view/menu/gu;->a()V

    iget v0, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->requestedWidth:I

    iget v1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->requestedHeight:I

    invoke-static {v0, v1}, Landroidx/appcompat/view/menu/fu;->a(II)Landroid/media/ImageReader$Builder;

    move-result-object v0

    const/4 v1, 0x5

    invoke-static {v0, v1}, Landroidx/appcompat/view/menu/zt;->a(Landroid/media/ImageReader$Builder;I)Landroid/media/ImageReader$Builder;

    const/16 v1, 0x22

    invoke-static {v0, v1}, Landroidx/appcompat/view/menu/au;->a(Landroid/media/ImageReader$Builder;I)Landroid/media/ImageReader$Builder;

    const-wide/16 v1, 0x100

    invoke-static {v0, v1, v2}, Landroidx/appcompat/view/menu/bu;->a(Landroid/media/ImageReader$Builder;J)Landroid/media/ImageReader$Builder;

    invoke-static {v0}, Landroidx/appcompat/view/menu/cu;->a(Landroid/media/ImageReader$Builder;)Landroid/media/ImageReader;
...
.method private maybeWaitOnFence(Landroid/media/Image;)V
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/view/menu/ba0;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private waitOnFence(Landroid/media/Image;)V
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/view/menu/du;->a(Landroid/media/Image;)Landroid/hardware/SyncFence;

    move-result-object p1

    invoke-static {p1}, Landroidx/appcompat/view/menu/eu;->a(Landroid/hardware/SyncFence;)Z
    :try_end_0
